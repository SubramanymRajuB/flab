                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  LifeCycleManager(child: IntializeTitle())),
                        );
                      },
                    ),
                    SizedBox(height: 10),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => NavigarionDemo()),
                        );
                      },
                    ),
                    SizedBox(height: 10),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SimpleBLocDemo()),
                        );
                      },
                    ),
                    SizedBox(height: 10),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Store<AppState> reduxStore = Store<AppState>(reducer,
                            initialState: AppState(sliderFontSize: 0.5));
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ReduxDemo(reduxStore)),
                        );
                      },
                    ),
                    SizedBox(height: 10),
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SimplePlatformMsg()),
                        );
                      },
                    ),
                    SizedBox(height: 10),
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => LocalizationDemo()),
                        );
                      },
                    ),
                    SizedBox(height: 10),
