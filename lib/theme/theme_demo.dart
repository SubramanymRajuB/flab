      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
                'In addition, 300 million people live in forests, including 60 million indigenous people.Yet, we are losing them.',
                style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold)),
            Padding(
              padding: const EdgeInsets.only(top: 16.0),
              child: Container(
